...
type CartItem struct {
	CartItemId primitive.ObjectID  `json:"cart_item_id" bson:"cart_item_id,omitempty"`
...
type Order struct {
	OrderId     primitive.ObjectID  `json:"order_id" bson:"order_id,omitempty"`
	UserId      primitive.ObjectID  `json:"user_id" bson:"user_id"`
...
type Payment struct {
	PaymentId     primitive.ObjectID  `json:"payment_id" bson:"payment_id,omitempty"`
